...
--> statement-breakpoint
CREATE UNIQUE INDEX `allowed_currencies_currency_unique` ON `allowed_currencies` (`currency`);
...
--> statement-breakpoint
CREATE UNIQUE INDEX `confirmation_token_id_unique` ON `confirmation_token` (`id`);

--> statement-breakpoint
CREATE UNIQUE INDEX `confirmation_token_token_unique` ON `confirmation_token` (`token`);

--> statement-breakpoint
CREATE UNIQUE INDEX `events_name_unique` ON `events` (`name`);

--> statement-breakpoint
CREATE UNIQUE INDEX `salaries_id_unique` ON `salaries` (`id`);
...
--> statement-breakpoint
CREATE UNIQUE INDEX `work_email_id_unique` ON `work_email` (`id`);
