...
import type { TransactionalEdmailService } from "./workers/transactional_email_service";
export interface Env {
  ...
  TRANSACTIONAL_EMAIL_SERVICE: Service<TransactionalEdmailService> | undefined;
}
